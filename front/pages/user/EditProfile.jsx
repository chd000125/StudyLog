...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        .then(res => {
            // name이 객체면 한 번 더 꺼내기
            let name = res.data.uName;
            while (typeof name === 'object' && name !== null) {
                name = name.uName;
            }
            setUser({
                name,
    ...
    const handleEditSubmit = async (e) => {
        ...
        console.log('editForm.uName:', editForm.uName);
        console.log('typeof editForm.uName:', typeof editForm.uName);
        await userAPI.updateName(editForm.uName);
        try {
